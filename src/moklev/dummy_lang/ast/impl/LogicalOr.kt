 ...
 */
class LogicalOr(ctx: ParserRuleContext, val left: Expression, val right: Expression) : BooleanExpression(ctx) {
    override fun compileBranch(builder: FunctionBuilder,
        ...
        left.compileBranch(builder, state, scope, labelIfTrue, intermediateLabel)
